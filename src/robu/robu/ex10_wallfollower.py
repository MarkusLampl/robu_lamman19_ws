...
class WallFollower(Node):
    ...
    def timer_callback(self):
        ...
        #Verhindert beim ersmaligen aufrufen liegen noch keine LIDAR Daten vor
            self.follow_wall()
    ...
    def follow_wall(self):
        ...
        if self.wallfollower_state == WallFollowerStates.WF_STATE_INVALID:
            ...
            if self.front_dist > (dist_min + self.dist_laser_offset): #Dreh ROboter solange bis auf der X-Achse der Mindestabstand erscheint.
                ...
                fd_fresh = self.dist_thresh_wf + self.dist_laser_offset
            ...
            > 0.05)) or ((self.front_dist != np.inf) and (sr == np.inf)):
                msg.angular.z = -self.turning.forward_speed_wf_fast
            else:
